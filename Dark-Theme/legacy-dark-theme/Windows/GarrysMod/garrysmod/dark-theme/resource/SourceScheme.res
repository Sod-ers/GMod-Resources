...
Scheme
{
	//////////////////////// COLORS ///////////////////////////INsanes CSS HUD V6 White normal fonts April 2011
	// color details
	...
	Colors
	{
		...
		"Menu_INF_Background"       "30 30 30 225"        //Main panel "in focus" color, reguard this as the Main color for BS's, it is what you see when clicking on a panel background. Make this lighter that the one below.
		"Menu_OOF_Background"	    "80 80 80 200"        //Main panel "out of focus color" it will "fade" when you select another panel and is better being a darker, translucent color
		"Menu_OOF_Text"	            "245 245 245 150"	  //Out of focus text color, like the panel, you want this a bit darker and more translucent
		"Menu_Armed_BG"	            "80 80 80 225"	      //The backgound of "Armed" items
		"Menu_Armed_Text"	        "255 255 255 200"	  //The text of Armed items
	    "Menu_Major_Titles"         "255 255 255 255"	  //The text of Major tiles
	    "Menu_Title"                "255 255 255 255"	  //The text of Menu left side main list		
		"Menu_Drop_BG"              "80 80 80 255"        //The Backgound color of the dropdown windows when dropped down
		"Menu_Border_LtGrey"        "220 220 220 255"     //Buttons, Border on bottom and right
		"Menu_Border_DkGrey"	    "180 180 180 200"	  //Buttons,Border on top and left
		"Menu_Highlight_Text"	    "245 245 245 255"	  //Highlight color for selected text		
		"Menu_Highlight_Text_BG"	"130 130 130 225"	      //Highlight background for selected text of the dropdown windows
		"Menu_Con_Mess_Text"        "255 255 0 255"	      //Text color of the text you enter in console... then displayed in the console
		"Menu_Con_Output_BG"        "80 80 80 225"	      //Background colour of output screens
	...
	BaseSettings
	{
		...
		Button.TextColor				"White"                 //"White" * INsane... the text color of button text...dah
		...
		FrameTitleBar.TextColor			"Menu_Major_Titles"         //"White" * INsane... Major panels Text color for titles.
		...
		ListPanel.SelectedBgColor			"Orange"             // tested no effect on main menu
		ListPanel.SelectedOutOfFocusBgColor	"255 155 0 128"
		ListPanel.EmptyListInfoTextColor	"OffWhite"

		Menu.TextColor					"White"              //"White" * INsane. The text color of the unselected item in a drop down window                  
		...
		SectionedListPanel.OutOfFocusSelectedBgColor	"255 155 0 128"             // tested no effect on main menu

		Slider.NobColor				"Menu_Con_Mess_Text"      //"108 108 108 255" * INsane. The slider knob... oh dear
		...
		TextEntry.OutOfFocusSelectedBgColor	           "AchievementsInactiveFG"   //"255 155 0 128" * INsane. The background of the deselected item in a input line like the console
	...
	Fonts
	{
		...
		"MenuLarge"         // INsane: Main menu font
		{
			"1"	[$OSX]
			{
				"name"		"Helvetica Bold"
		...
		"ConsoleText"                         //* INsane...  console output text size
		{
			"1"
			{
				"name"		 "Trebuchet MS"   [$WINDOWS]  //"Lucida Console" [$WINDOWS] * INsane... hate that font, can't read it clear
				"name"		 "Lucida Console" [$X360]
				"name"		 "Verdana"        [$POSIX]
				"tall"		 "11"             [$POSIX]
				"tall"		 "16"             // * INsane... 10 mate? This is too small guys, oh dear devs are on drugs again :p
				"weight"	 "500"            // * INsane... "500"	
			}
		}
